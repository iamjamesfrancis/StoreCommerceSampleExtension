...
declare module Commerce.Proxy.Entities {
    ...
    enum ProductDataValidationErrors {
        ...
        Microsoft_Dynamics_Commerce_Runtime_NotValidProductSearchCriteria = 6,
        Microsoft_Dynamics_Commerce_Runtime_CategoryAttributeTypeNotSupported = 7
    }
    ...
    enum SecurityErrors {
        ...
        Microsoft_Dynamics_Commerce_Runtime_UpdatePasswordFailed = 13,
        Microsoft_Dynamics_Commerce_Runtime_ResetPasswordFailed = 14,
        Microsoft_Dynamics_Commerce_Runtime_NonDrawerOperationsOnly = 15,
        Microsoft_Dynamics_Commerce_Runtime_UseExistingShiftPermissionDenied = 16,
        Microsoft_Dynamics_Commerce_Runtime_CreateTransferOrderNotAllowed = 17,
        Microsoft_Dynamics_Commerce_Runtime_UserCannotMassActivation = 18,
        Microsoft_Dynamics_Commerce_Runtime_OpenMultipleShiftsNotAllowed = 19,
        Microsoft_Dynamics_Commerce_Runtime_UserSessionNotOpened = 20,
        Microsoft_Dynamics_Commerce_Runtime_HeadquarterTransactionServiceMethodCallFailure = 21,
        Microsoft_Dynamics_Commerce_Runtime_HeadquarterCommunicationFailure = 22,
        Microsoft_Dynamics_Commerce_Runtime_DeviceTokenExpired = 23,
        Microsoft_Dynamics_Commerce_Runtime_DeviceTokenNotPresent = 24,
        Microsoft_Dynamics_Commerce_Runtime_InvalidChannel = 25,
        Microsoft_Dynamics_Commerce_Runtime_ElevatedUserSameAsLoggedOnUser = 26,
        Microsoft_Dynamics_Commerce_Runtime_GrantTypeNotSupported = 27,
        Microsoft_Dynamics_Commerce_Runtime_DeviceDeactivationFailed = 28,
        Microsoft_Dynamics_Commerce_Runtime_HardwareStationTokenCreationFailed = 29,
        Microsoft_Dynamics_Commerce_Runtime_InvalidHardwareStationToken = 30,
        Microsoft_Dynamics_Commerce_Runtime_UserLogonAnotherTerminal = 31,
        Microsoft_Dynamics_Commerce_Runtime_UnlockRegisterFailed = 32,
        Microsoft_Dynamics_Commerce_Runtime_ChannelDatabaseConnectionFailed = 33,
        Microsoft_Dynamics_Commerce_Runtime_InvalidUserToken = 34,
        Microsoft_Dynamics_Commerce_Runtime_CustomerAccountAuthorizationFailure = 35,
        Microsoft_Dynamics_Commerce_Runtime_LocalLogonFailed = 36,
        Microsoft_Dynamics_Commerce_Runtime_LocalDeviceAuthenticationFailed = 37,
        Microsoft_Dynamics_Commerce_Runtime_DeviceTokenValidationFailed = 38,
        Microsoft_Dynamics_Commerce_Runtime_NoDeviceManagementPermission = 39,
        Microsoft_Dynamics_Commerce_Runtime_IncorrectLogonTypeUserAccountOrPassword = 40,
        Microsoft_Dynamics_Commerce_Runtime_InvalidAudience = 41,
        Microsoft_Dynamics_Commerce_Runtime_InvalidIssuer = 42,
        Microsoft_Dynamics_Commerce_Runtime_TenantIdNotFound = 43,
        Microsoft_Dynamics_Commerce_Runtime_AADTokenIssuedForDifferentEnvironment = 44,
        Microsoft_Dynamics_Commerce_Runtime_InvalidAADTenantId = 45,
        Microsoft_Dynamics_Commerce_Runtime_UserBlockedDueToTooManyFailedLogonAttempts = 46,
        Microsoft_Dynamics_Commerce_Runtime_UserPasswordExpired = 47,
        Microsoft_Dynamics_Commerce_Runtime_CheckOutNotOverHTTPS = 48,
        Microsoft_Dynamics_Commerce_Runtime_AttemptToActivateFromDifferentPhysicalDevice = 49,
        Microsoft_Dynamics_Commerce_Runtime_InternalServerError = 50,
        Microsoft_Dynamics_Commerce_Runtime_DeviceActivationNotAllowedWithUserTokenIssuer = 51,
        Microsoft_Dynamics_Commerce_Runtime_PasswordComplexityRequirementsNotMet = 52,
        Microsoft_Dynamics_Commerce_Runtime_PasswordHistoryRequirementsNotMet = 53,
        Microsoft_Dynamics_Commerce_Runtime_ReturnItemPriceExceeded = 54,
        Microsoft_Dynamics_Commerce_Runtime_ReturnTransactionTotalExceeded = 55,
        Microsoft_Dynamics_Commerce_Runtime_CredentialsNotConfigured = 56,
        Microsoft_Dynamics_Commerce_Runtime_PolicyBypassNotAllowed = 57,
        Microsoft_Dynamics_Commerce_Runtime_OnBehalfOfNotAllowed = 58
    }
    enum StorageErrors {
        None = 0,
    ...
    interface ReadChangedProductsSession {
        ...
        NumberOfChangedProductsAcrossCatalogs?: number;
    ...
    class OnlineChannelClass implements OnlineChannel {
        ...
        ExtensionProperties: Entities.CommerceProperty[];
        CountryRegions: Entities.CountryRegion[];
        static countryRegionsPropertyName: string;
        constructor(odataObject?: any);
    }
...
declare namespace Commerce.Triggers {
    ...
    type DataModificationCancelableTriggerTypeName = CancelableTriggerTypeName & ("PreAdjustStockCountLineQuantity" | "PreCreatePackingSlip" | "PreCreateInventoryDocument" | "PreCreateTransferOrder" | "PreElevateUser" | "PreGetFulfillmentLines" | "PreLogOn" | "PreMarkFulfillmentLinesAsPacked" | "PreOpenUrl" | "PreSaveCustomerAddress" | "PreSaveStockCountJournal" | "PreSearchOrders" | "PreSelectTransactionPaymentMethod" | "PreShipFulfillmentLines" | "PreShipSelectedCartLines" | "PreUnlockTerminal" | "PreUpdateInventoryAdjustmentDocumentLineNote" | "PreUpdateInventoryDocument" | "PreUpdateTransferOrder" | "PreUpdateInventoryAdjustmentDocumentAddedProductLine");
